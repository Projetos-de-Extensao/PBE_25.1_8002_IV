...
<p align = "justify">
Para a primeira geração do Diagrama de Classes foi Utilizado o PlantUML e o Visual Studio Code para elaborar o documento.A equipe se reuniu por chamada de voz para discutir o diagrama.
</p>
